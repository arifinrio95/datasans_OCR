...
def ocr_analyze(ocr_output, doc_type):
    messages = [
        ...
        {"role": "user", "content": f"""Ini adalah hasil OCR dari dokumen {doc_type}. Rapikan text-nya dalam format streamlit, lalu berikan analisamu sebagai 'Notes dari SansGPT'. Text OCR:  {ocr_output}."""}
    ]
