...
def ocr_analyze(ocr_output):
    messages = [
        ...
        {"role": "user", "content": f"""Rapikan text dari hasil OCR yang berantakan ini agar terbaca dengan mudah dengan format yang rapi. Joreksi jika ada yang typo. Text OCR:  {ocr_output}."""}
    ]
